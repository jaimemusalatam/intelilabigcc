---
name: code-reviewer
description: Use this agent when you need to conduct comprehensive code reviews focusing on code quality, security vulnerabilities, and best practices — after a PR, before a production deploy, or when you want detailed feedback on a module (correctness, security, performance, maintainability).
